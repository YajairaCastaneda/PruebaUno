package cl.bci.aplicaciones.productos.colocaciones.simulacion.to;

import java.io.Serializable;
import java.util.Date;

/**
 * <b>ResultSimulaProcesoCHIPTO</b> Objeto que contiene la informacion de los
 * parametros de la simulacion que seran enviados al proceso CHIP.
 * <p>
 * Registro de versiones:
 * <ul>
 * <li>1.0 08/04/2015 Jose Palma (TINet) - Patricio Candia (Ing. Soft. BCI): version inicial.</li>
 * </ul>
 * <B>Todos los derechos reservados por Banco de Crédito e Inversiones.</B>
 * </p>
 */
public class ResultSimulaProcesoCHIPTO implements Serializable {
	/**
	...
	/**
	 * Atributo que representa el total de las simulaciones realizadas por el
	 * cliente.
	 */
	 ...
	 */
	private SimulacionPlazoTO simulacionPlazoColectivo;

	/**
	 * Atributo que representa el detalle del dividendo individual.
	 */
	private SimulacionPlazoTO simulacionPlazoIndividual;

	/**
	 * Atributo que representa el detalle del dividendo colectivo para el tramo
	 * 2.
	 */
	private SimulacionPlazoTO simulacionPlazoPagaLaMitadColectivo;

	/**
	 * Atributo que representa el detalle del dividendo individual para el tramo
	 * 2.
	 */
	private SimulacionPlazoTO simulacionPlazoPagaLaMitadIndividual;
	...
	/**
	 * Atributo que representa si el cliente elige el seguro de cesantia
	 * involuntaria.
	 */
	...
	/**
	 * Atributo que representa si el cliente elige el seguro de cesantia doble
	 * proteccion.
	 */
	private boolean seguroCesantiaDobleProteccion;

	/**
	 * Atributo que representa el monto total asociado a los seguros contratados
	 * en UF.
	 */
	...
	/**
	 * Atributo que representa el tipo de seguro de desgravamen individual
	 * elegido.
	 */
	private String glosaSeguroDesgravamenIndividual;

	/**
	 * Atributo que representa codigo del tipo de seguro de desgravamen
	 * individual elegido.
	 */
	private String codSeguroDesgravamenIndividual;

	/**
	 * Atributo que representa el tipo de seguro de incendio y sismo individual
	 * elegido.
	 */
	private String glosaSeguroIncendioSismoIndividual;

	/**
	 * Atributo que representa codigo del tipo de seguro de incendio y sismo
	 * individual elegido.
	 */
	...
	/**
	 * Atributo que representa los gastos operacionales de la simulacion en
	 * Pesos.
	 */
	private GastosOperacionalesTO gastosOperacionalesPesos;

	/**
	 * Atributo que representa los gastos operacionales de la simulacion en UF.
	 */
	private GastosOperacionalesTO gastosOperacionalesUF;
	...
	/**
	 * Atributo que representa la fecha en que se realiza la instancia CHIP de
	 * la simulacion.
	 */
	private Date fechaInstanciaCHIP;

	/**
	 * Atributo que representa el codigo del ejecutivo que realiza la
	 * simulacion.
	 */
	...
	public SimulacionPlazoTO getSimulacionPlazoColectivo() {
		return simulacionPlazoColectivo;
	}

	public SimulacionPlazoTO getSimulacionPlazoIndividual() {
		return simulacionPlazoIndividual;
	}

	public SimulacionPlazoTO getSimulacionPlazoPagaLaMitadColectivo() {
		return simulacionPlazoPagaLaMitadColectivo;
	}

	public SimulacionPlazoTO getSimulacionPlazoPagaLaMitadIndividual() {
	...
	public GastosOperacionalesTO getGastosOperacionalesPesos() {
		return gastosOperacionalesPesos;
	}

	public GastosOperacionalesTO getGastosOperacionalesUF() {
	...
	public void setPorcentajeSegDesgravamenCliente(
			double porcentajeSegDesgravamenCliente) {
	...
	public void setPorcentajeSegDesgravamenCodeudor(
			double porcentajeSegDesgravamenCodeudor) {
	...
	public void setGlosaSeguroIncendioSismoOpcional(
			String glosaSeguroIncendioSismoOpcional) {
		this.glosaSeguroIncendioSismoOpcional = glosaSeguroIncendioSismoOpcional;
	}

	public void setCodSeguroIncendioSismoOpcional(
			int codSeguroIncendioSismoOpcional) {
	...
	public void setSimulacionPlazoColectivo(
			SimulacionPlazoTO simulacionPlazoColectivo) {
		this.simulacionPlazoColectivo = simulacionPlazoColectivo;
	}

	public void setSimulacionPlazoIndividual(
			SimulacionPlazoTO simulacionPlazoIndividual) {
		this.simulacionPlazoIndividual = simulacionPlazoIndividual;
	}

	public void setSimulacionPlazoPagaLaMitadColectivo(
			SimulacionPlazoTO simulacionPlazoPagaLaMitadColectivo) {
	...
	public void setSimulacionPlazoPagaLaMitadIndividual(
			SimulacionPlazoTO simulacionPlazoPagaLaMitadIndividual) {
	...
	public void setCostoTotalCreditoIndividual(
			double costoTotalCreditoIndividual) {
	...
	public void setSeguroCesantiaDobleProteccion(
			boolean seguroCesantiaDobleProteccion) {
		this.seguroCesantiaDobleProteccion = seguroCesantiaDobleProteccion;
	}

	public void setTotalPrimaSegurosEscogidosUF(
			double totalPrimaSegurosEscogidosUF) {
		this.totalPrimaSegurosEscogidosUF = totalPrimaSegurosEscogidosUF;
	}

	public void setTotalPrimaSegurosEscogidosPesos(
			double totalPrimaSegurosEscogidosPesos) {
		this.totalPrimaSegurosEscogidosPesos = totalPrimaSegurosEscogidosPesos;
	}

	public void setGlosaSeguroDesgravamenIndividual(
			String glosaSeguroDesgravamenIndividual) {
		this.glosaSeguroDesgravamenIndividual = glosaSeguroDesgravamenIndividual;
	}

	public void setCodSeguroDesgravamenIndividual(
			String codSeguroDesgravamenIndividual) {
		this.codSeguroDesgravamenIndividual = codSeguroDesgravamenIndividual;
	}

	public void setGlosaSeguroIncendioSismoIndividual(
			String glosaSeguroIncendioSismoIndividual) {
		this.glosaSeguroIncendioSismoIndividual = glosaSeguroIncendioSismoIndividual;
	}

	public void setCodSeguroIncendioSismoIndividual(
			String codSeguroIncendioSismoIndividual) {
	...
	public void setGastosOperacionalesPesos(
			GastosOperacionalesTO gastosOperacionalesPesos) {
		this.gastosOperacionalesPesos = gastosOperacionalesPesos;
	}

	public void setGastosOperacionalesUF(
			GastosOperacionalesTO gastosOperacionalesUF) {
		this.gastosOperacionalesUF = gastosOperacionalesUF;
	}

	public void setTotalGastosOperacionalesPesos(
			double totalGastosOperacionalesPesos) {
    ...
    public String toString() {
		...
		sb.append("ResultSimulaProcesoCHIPTO: rutCliente[").append(rutCliente);
		...
		sb.append("], porcentajeSegDesgravamenCliente[").append(
				porcentajeSegDesgravamenCliente);
		sb.append("], codeudor[").append(codeudor);
		sb.append("], fechaNacimientoCodeudor[")
				.append(fechaNacimientoCodeudor);
		sb.append("], porcentajeSegDesgravamenCodeudor[").append(
				porcentajeSegDesgravamenCodeudor);
		...
		sb.append("], glosaAntiguedadVivienda[")
				.append(glosaAntiguedadVivienda);
		sb.append("], codSeguroIncendioSismoOpcional[").append(
				codSeguroIncendioSismoOpcional);
		sb.append("], glosaSeguroIncendioSismoOpcional[").append(
				glosaSeguroIncendioSismoOpcional);
		...
		sb.append("], porcentajeFinanciamiento[").append(
		...
		sb.append("], glosaTipoFinanciamiento[")
				.append(glosaTipoFinanciamiento);
		...
		sb.append("], simulacionPlazoColectivo[").append(
				simulacionPlazoColectivo);
		sb.append("], simulacionPlazoIndividual[").append(
				simulacionPlazoIndividual);
		sb.append("], simulacionPlazoPagaLaMitadColectivo[").append(
				simulacionPlazoPagaLaMitadColectivo);
		sb.append("], simulacionPlazoPagaLaMitadIndividual[").append(
				simulacionPlazoPagaLaMitadIndividual);
		sb.append("], tasaCAEColectivo[").append(tasaCAEColectivo);
		sb.append("], tasaCAEIndividual[").append(tasaCAEIndividual);
		sb.append("], costoTotalCreditoColectivo[").append(
				costoTotalCreditoColectivo);
		sb.append("], costoTotalCreditoIndividual[").append(
				costoTotalCreditoIndividual);
		...
		sb.append("], seguroCesantiaDobleProteccion[").append(
				seguroCesantiaDobleProteccion);
		sb.append("], totalPrimaSegurosEscogidosUF[").append(
				totalPrimaSegurosEscogidosUF);
		sb.append("], totalPrimaSegurosEscogidosPesos[").append(
				totalPrimaSegurosEscogidosPesos);
		sb.append("], codSeguroDesgravamenIndividual[").append(
				codSeguroDesgravamenIndividual);
		sb.append("], glosaSeguroDesgravamenIndividual[").append(
				glosaSeguroDesgravamenIndividual);
		sb.append("], codSeguroIncendioSismoIndividual[").append(
				codSeguroIncendioSismoIndividual);
		sb.append("], glosaSeguroIncendioSismoIndividual[").append(
				glosaSeguroIncendioSismoIndividual);
		sb.append("], codSeguroAdicional[").append(codSeguroAdicional);
		sb.append("], glosaSeguroAdicional[").append(glosaSeguroAdicional);
		sb.append("], gastosOperacionalesPesos[").append(
				gastosOperacionalesPesos);
		sb.append("], gastosOperacionalesUF[").append(gastosOperacionalesUF);
		sb.append("], totalGastosOperacionalesPesos[").append(
				totalGastosOperacionalesPesos);
